...
// Reducer
e.default=(0,s.handleActions)(function(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}({},i,function(t,e){var r=e.payload.count;return t.set("count",r)}),u);
// Actions
var c=(0,s.createActions)({COUNTER_SET_COUNT:function(t){return{count:t}}}),a=c.counterSetCount;
// Selectors
e.counterSetCount=a;var l=(e.counterCountSelector=function(t,e){return t.counter.get("count")},function(t){return t.ofType(i).mergeMap(function(t){var e=t.payload.count;
// BOOG
